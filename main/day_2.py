...
class start:
    ...
    def basic(self):
        ...
        last_page = int(str(self.driver.find_element_by_class_name("lnkLastPage").text).split(" ")[1])
        ...
        for infolar in data:
            ...
            try :
                if str(title) == "Sektör":
                    ...
                    Web_Site.append(str(description.get_attribute("href")))
...
df.to_excel(writer, sheet_name='DENEME')
writer.save()
print(df)
